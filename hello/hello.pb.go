...
const file_hello_hello_proto_rawDesc = "" +
	"\n" +
	"\x11hello/hello.proto\x12\x0fgrpc.demo.hello\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2Y\n" +
	"\fHelloService\x12I\n" +
	"\bSayHello\x12\x1d.grpc.demo.hello.HelloRequest\x1a\x1e.grpc.demo.hello.HelloResponseB*Z(github.com/archine/grpc-demo-proto/hellob\x06proto3"
...
var file_hello_hello_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: grpc.demo.hello.HelloRequest
	(*HelloResponse)(nil), // 1: grpc.demo.hello.HelloResponse
}
var file_hello_hello_proto_depIdxs = []int32{
	0, // 0: grpc.demo.hello.HelloService.SayHello:input_type -> grpc.demo.hello.HelloRequest
	1, // 1: grpc.demo.hello.HelloService.SayHello:output_type -> grpc.demo.hello.HelloResponse
